...
<div class="page-header">
    <div>
        ...
        <p class="page-subtitle">Tambah data driver baru ke sistem</p>
    </div>
    ...
    <div class="card-body">
        <form action="{{ route('drivers.store') }}" method="POST" class="row g-3">
            ...
            <div class="col-md-6">
                ...
                <input type="text" name="nama_driver" value="{{ old('nama_driver') }}"
                       class="form-control @error('nama_driver') is-invalid @enderror" required>
                @error('nama_driver')
            ...
            <div class="col-md-6">
                ...
                <select name="jenis_sim" class="form-select @error('jenis_sim') is-invalid @enderror">
                    ...
                    <option value="B2" {{ old('jenis_sim') == 'B2' ? 'selected' : '' }}>SIM B2</option>
                </select>
                @error('jenis_sim')
                    <small class="text-danger">{{ $message }}</small>
                @enderror
